...
- Quarterly CalVer is settled. The current compiler version is `2026.3.1-rc-2`; Stable is `YYYY.Q.R`, Release Candidate is `YYYY.Q.R-rc-N`, and Development is the separate `dev-YYYY.Q.R` channel.
